...
import {
  ...
  createLifeGoalPhase,
  updateLifeGoalPhase,
  createLifeGoalRelation,
  removeLifeGoalRelation,
  assignLifeTaskPhase,
  createLifeGoalRoute,
  updateLifeGoalRoute,
  ...
  if (showInitialLoader) {
    ...
    currentView = (
      <WishHubView
        ...
        lifePlanningProps={{
          phases: snapshot.lifeGoalPhases || [],
          relations: snapshot.lifeGoalRelations || [],
          workspaceReady: snapshot.lifeWorkspaceSchemaReady,
          onCreatePhase: (input) => runAction(() => createLifeGoalPhase({ ...input, created_by: member.user_id }), 'フェーズを追加しました'),
          onUpdatePhase: (id, input) => runAction(() => updateLifeGoalPhase(id, input), 'フェーズを更新しました'),
          onCreateRelation: (input) => runAction(() => createLifeGoalRelation({ ...input, created_by: member.user_id }), '目標をつなぎました'),
          onRemoveRelation: (source, target) => runAction(() => removeLifeGoalRelation(source, target), '関連を解除しました'),
          onAssignTaskPhase: (goalId, taskId, phaseId) => runAction(() => assignLifeTaskPhase(goalId, taskId, phaseId), 'フェーズを変更しました'),
